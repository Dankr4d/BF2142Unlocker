...
type
  ServerSettings* {.Prefix: "GameServerSettings.".} = object
    ...
    internet* {.Setting: "setInternet", Valid: Bools01, Default: true.}: bool # 1
    ...
    punishTeamKills* {.Setting: "setPunishTeamKills", Valid: Bools01, Default: true.}: bool # 1
    votingEnabled* {.Setting: "setVotingEnabled", Valid: Bools01, Default: true.}: bool # 1
    ...
    voipEnabled* {.Setting: "setVoipEnabled", Valid: Bools01, Default: true.}: bool # 1
    voipQuality* {.Setting: "setVoipQuality", Default: 3u8.}: uint8 # 3 # TODO: range
    voipServerRemote* {.Setting: "setVoipServerRemote", Valid: Bools01, Default: false.}: bool # 0
    ...
    autoRecord* {.Setting: "setAutoRecord", Valid: Bools01, Default: false.}: bool # 0
    svPunkBuster* {.Setting: "setSvPunkBuster", Valid: Bools01, Default: false.}: bool # 0
    teamRatio* {.Setting: "setTeamRatio", Default: 100u8.}: uint8 # 100 # TODO: range
    autoBalanceTeam* {.Setting: "setAutoBalanceTeam", Valid: Bools01, Default: false.}: bool # 0
