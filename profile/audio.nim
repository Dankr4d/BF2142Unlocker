...
type
  ...
  Audio* {.Prefix: "AudioSettings.".} = object
    voipEnabled* {.Setting: "setVoipEnabled", Valid: Bools01, Default: true.}: bool
    ...
    voipBoostEnabled* {.Setting: "setVoipBoostEnabled", Valid: Bools01, Default: false.}: bool # TODO: When changing ingame, it's not set in config.
    voipUsePushToTalk* {.Setting: "setVoipUsePushToTalk", Valid: Bools01, Default: true.}: bool # TODO: It's not possible to set this setting ingame.
    ...
    englishOnlyVoices* {.Setting: "setEnglishOnlyVoices", Valid: Bools01, Default: false.}: bool
    enableEax* {.Setting: "setEnableEAX", Valid: Bools01, Default: true.}: bool
